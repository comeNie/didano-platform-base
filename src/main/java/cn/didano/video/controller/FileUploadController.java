...
public class FileUploadController {
    ...
    public String handleFileUpload( @RequestParam("file") List<MultipartFile> files,@RequestParam("name") String name,
      @RequestParam("correct") String correct,@RequestParam("prepare") String prepare,@RequestParam("question") String question,
      @RequestParam("answerOkWords") String answerOkWord,@RequestParam("answerOkAction") String answerOkAction,@RequestParam("answerErrorAction") String answerErrorAction,
      @RequestParam("answerErrorWords") String answerErrorWord,@RequestParam("goodbyeWords") String goodbyeWord,@RequestParam("goodbyeAction") String goodbyeAction,
      @RequestParam("suitable_age") String suitable_age,@RequestParam("ParentKinds") String kindsParent,
      @RequestParam("kinds") String kinds,@RequestParam("author") String author,@RequestParam("school_id") int school_id,
